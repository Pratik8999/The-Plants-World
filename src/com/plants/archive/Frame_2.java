  ...
  if(e.getSource()== b4)
  {
    ...
    try
     
     {
     	...
     	ResultSet r1=s1.executeQuery("select sum(p_qty) from Sale where s_date='"+tf4.getText()+"' and p_name='"+t.getText()+"'");
     	r1.next();
